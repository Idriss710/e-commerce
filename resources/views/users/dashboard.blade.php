...
@section('content')
                    ...
                    <div class="tab-content" id="myTabContent">
                                                ...
                                                <div class="order-box">
                                                    ...
                                                    <div class="order-box-contain">
                                                        ...
                                                        <div>
                                                            ...
                                                            <h3> @if (session('wishlistCount') == null) 0 @else {{session('wishlistCount')}}  @endif</h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="box">
                                                    <div class="box-content">
                                                        ...
                                                        <h6 class="font-light">{{Auth::user()->email}}</6>
                                                        <h6 class="font-light">{{Auth::user()->phone}}</h6>
                                                        <a href="{{route('user.editPage')}}">Edit </a>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="tab-pane fade dashboard-security dashboard" id="security">
                            ...
                            <div class="security-details-1 mb-0">
                                ...
                                <button class="btn btn-solid-default btn-sm fw-bold rounded" data-bs-toggle="modal" data-bs-target="#deleteModal" onclick="event.preventDefault();document.getElementById('frmDeleteUser').submit();">Delete Your
                                    Account</button>
                                    <form id="frmDeleteUser" action="{{route('user.remove',Auth::user())}}" method="get">
                                        @csrf
    ...
    <!-- Subscribe Section End -->@endsection