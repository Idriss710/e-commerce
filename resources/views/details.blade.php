                    ...
                    <div class="row g-4">
                                    ...
                                    <div class="details-image-vertical black-slide rounded">
                                        ...
                                        @if ($product->images)
                                            ...
                                            @foreach ($images as $img)
                                                <div>
                                                    <img src="{{asset('assets/images/fashion/product/front')}}/{{$img}}"
                                    ...
                                    <div class="details-image-1 ratio_asos">
                                        <div>
                                            <img src="{{asset('assets/images/fashion/product/front')}}/{{$product->image}}" 
                                                ...
                                                class="img-fluid w-100 image_zoom_cls-0 blur-up lazyload" alt="{{$product->image}}">
                                        </div>
                                        @if ($product->images)
                                            @php
                                                $images = explode(',',$product->images);
                                            ...
                                            @foreach ($images as $img)
                                                ...
                                                <div>
                                                    <img src="{{asset('assets/images/fashion/product/front')}}/{{$img}}" id="zoom_02"
                                                        data-zoom-image="{{asset('assets/images/fashion')}}/{{$img}}"
                                                        class="img-fluid w-100 image_zoom_cls-1 blur-up lazyload" alt="{{$img}}">
                                                </div>
                                            @endforeach
                                        @endif
                        ...
                        <div class="col-md-6">
                            <div class="cloth-details-size">
                                ...
                                @if ($product->reqular_price)
                                    <h3 class="price-detail"> ${{$product->sale_price}} 
                                    <del>${{$product->reqular_price}}</del>
                                    <span>{{round((($product->reqular_price-$product->sale_price)/$product->reqular_price)*100)}} % off</span></h3>
                                @endif
                                ...
                                <div class="product-buttons">
                                    ...
                                    <a href="javascript:void(0)" onclick="addQuantityToCart()"                                            
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="{{route('productDetails',['slug'=>$pro->slug])}}">
                                                <img src="{{asset('assets/images/fashion/product/front')}}/{{$pro->image}}"
                                                    class="bg-img blur-up lazyload" alt="">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="{{route('productDetails',['slug'=>$pro->slug])}}">
                                                <img src="{{asset('assets/images/fashion/product/back')}}/{{$pro->image}}"
                                                    class="bg-img blur-up lazyload" alt="">
                                            </a>
                                        </div>
                                        <div class="cart-wrap">
                                    ...
                                    <div class="product-details">
                                        <div class="rating-details">
                                            <span class="font-light grid-content">{{$pro->brand->name}}</span>
                                        ...
                                        <div class="main-price">
                                            <a href="{{route('productDetails',['slug'=>$pro->slug])}}" class="font-default">
                                                <h5>{{$pro->name}}</h5>
                                            </a>
                                            <div class="listing-content">
                                                <span class="font-light">{{$pro->category->name}}</span>
                                                <p class="font-light">{{$pro->short_description}}</p>
                                            </div>
